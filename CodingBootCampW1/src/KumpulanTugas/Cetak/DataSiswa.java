...
public class DataSiswa {
    ...
    public static void PrintToTxt() throws IOException{
        iterator = listSt.iterator();
        FileWriter writer = new FileWriter("C:\\Users\\user\\IdeaProjects\\KumpulanTugas_Week1_Bootcamp\\src\\main\\java\\Cetak\\Data_Mahasiswa.txt");
        int no = 1;
